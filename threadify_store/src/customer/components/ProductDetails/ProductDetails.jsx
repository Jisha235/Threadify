...
<section className='grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-10 px-4 pt-10'>
    ...
    {/* Product info */}
    <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-w-7xl lg:px-8 lg:pb-24">
          <div className="lg:col-span-2">
            <h1 className="text-lg lg:text-xl font-semibold text-gray-900">Park Avenue</h1>
            <h1 className='let-lg lg:tet-xl text-gray-900 opacity-60 pt-1'>Men Shirt Pink</h1>
          </div>

          {/* Options */}
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            <h2 className="sr-only">Product information</h2>
            <div className='flex space-x-8 items-center text-lg lg:text-xl text-gray-900 mt-6 '>
            <p className="font-semibold">$35</p>
            <p className="opacity-50 line-through">$45</p>
            ...
            <div className="mt-6">
                ...
                <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>3866 Reviews</p>
                </div>
...
{/* Rating and reviews */}
<section>
    <h1 className='font-semibold lext-lg pb-4'>Recent Reviews & Rating</h1>
    ...
    <Grid container spacing={7}>
        ...
        <Grid item xs={5}>
            ...
            <Box className="mt-5 space-y-3">
                <Grid conatiner alignItems="center" gap={2}>
                    <Grid item xs={2}>
                        <p>Excellent</p>
                    </Grid>
                    <Grid item xs={7}>
        ...
        <section className='pt-10'>
            ...
            <div className='flex flex-wrap space-y-5'>
                {men_shirts.map((item)=><HomeSectionCard product={item}/>)}
            </div>
        </section>
