...
async function shipOrder(orderId){
    ...
    order.paymentDetails.status ="SHIPPED";
...
async function deliverOrder(orderId){
    ...
    order.paymentDetails.status ="DELIVERED";
...
module.exports ={
    createOrder, placeOrder,confirmedOrder, shipOrder, deliverOrder, cancelOrder, findOrderById, userOrderHistory, getAllOrders, deleteOrder 
}